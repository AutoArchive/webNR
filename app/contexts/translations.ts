...
export const translations: Translations = {
  en: {
    ...
    'settings.appDescription': 'A decentralized novel reader that prioritizes privacy by processing all book data locally, with no login required. Connect to any compatible repository or import your own content.',
    'settings.privacyTitle': 'Privacy First',
    'settings.privacyDescription': 'Books and reading progress stay local. Google Analytics records sanitized public page views only; import URLs and reading data are excluded.',
  ...
  zh: {
    ...
    'settings.appInfo': '关于',
    'settings.appDescription': '去中心化、跨平台的在线阅读器，书籍数据在浏览器本地处理，无需登录。可以通过 PWA 安装到任意平台，并连接兼容书源或导入本地内容。',
    'settings.privacyTitle': '隐私优先',
    'settings.privacyDescription': '书籍与阅读进度保存在本地。Google Analytics 仅记录去除查询参数的公开页面浏览，不收集导入网址或阅读数据。',
