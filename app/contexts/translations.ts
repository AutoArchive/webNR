...
export const translations: Translations = {
  en: {
    ...
    'settings.appDescription': 'A decentralized novel reader that keeps book data in the browser and requires no login. Connect to compatible repositories or import your own content.',
  ...
  zh: {
    ...
    'settings.appInfo': '关于',
    'settings.appDescription': '去中心化、跨平台的在线阅读器，书籍数据保存在浏览器中，无需登录。可以连接兼容书源或导入自己的内容。',
