...
export const translations: Translations = {
  en: {
    ...
    'discover.novel.visit': 'Visit Page',
    ...
    'settings.appDescription': 'A decentralized novel reader that keeps book data in the browser and requires no login. Connect to compatible repositories or import your own content. For Legado users, WebNR can also serve as an independent browser-based alternative for web-first reading; it is not an official Legado client.',
    'settings.privacyTitle': 'Data and Analytics',
    'settings.privacyDescription': 'Books and reading progress stay in this browser. Google Analytics records page views with the complete page URL, including import URL query parameters.',
    ...
    'tts.voice': 'Voice',
    'tts.start': 'Start Reading',
    'tts.stop': 'Stop Reading',
    'tts.section': 'Section {current} of {total}',
    'tts.previous': 'Previous Section',
    'tts.next': 'Next Section',
  },
  zh: {
    'common.back': '返回',
    'common.settings': '设置',
    ...
    'discover.novel.visit': '访问网页',
    'discover.novel.showMore': '显示更多',
    'discover.novel.showLess': '收起',
    'discover.novel.addToLibrary': '添加到书架',
    'settings.appInfo': '关于',
    'settings.appDescription': '去中心化、跨平台的在线阅读器，书籍数据保存在浏览器中，无需登录。可以连接兼容书源或导入自己的内容。对于 Legado 用户，WebNR 也可以作为独立的网页端替代选择，适合网页优先的阅读场景；WebNR 不是 Legado 官方客户端。',
    'settings.privacyTitle': '数据与分析',
    'settings.privacyDescription': '书籍与阅读进度保存在当前浏览器。Google Analytics 会记录完整页面网址，包括导入网址查询参数。',
    ...
    'tts.start': '开始朗读',
    'tts.stop': '停止朗读',
    'tts.section': '第 {current} 节，共 {total} 节',
    'tts.previous': '上一节',
    'tts.next': '下一节',
  },
};
